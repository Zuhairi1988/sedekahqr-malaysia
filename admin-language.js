(() => {
  ...
  const translations = {
    ...
    'Kawalan perbelanjaan': 'Spending controls', 'Kos website': 'Website costs', 'Anggaran dikira dalam Ringgit Malaysia berdasarkan artikel automatik yang telah diterbitkan dan kos tetap yang anda masukkan.': 'Estimates are calculated in Malaysian Ringgit from published automated articles and fixed costs you enter.', 'Kos API dikesan daripada penggunaan automasi artikel. Perkhidmatan asas dipaparkan mengikut pelan semasa.': 'API costs are detected from article automation usage. Core services are shown according to the current plan.',
    'Anggaran bulan ini': 'Estimate this month', 'Kos tetap dan automasi artikel': 'Fixed costs and article automation', 'Kos automasi terkumpul': 'Cumulative automation cost', 'Anggaran setiap artikel': 'Estimate per article', 'DataForSEO dan DeepSeek': 'DataForSEO and DeepSeek', 'DataForSEO, DeepSeek dan GPT Image': 'DataForSEO, DeepSeek and GPT Image', 'Kos tetap sebulan': 'Fixed monthly cost', 'Termasuk pecahan domain tahunan': 'Includes annual domain allocation',
    'token direkodkan': 'tokens recorded', 'imej artikel direkodkan': 'article images recorded', 'Pecahan': 'Breakdown', 'Kos semasa': 'Current costs', 'Tetapan anggaran': 'Estimate settings', 'Masukkan kos anda': 'Enter your costs', 'Masukkan caj sebenar daripada invois atau dashboard penyedia servis. Nilai RM0 bermaksud tiada caj.': 'Enter actual charges from invoices or provider dashboards. RM0 means no charge.',
    ...
    'Contoh: E-mel atau storan': 'Example: Email or storage', 'artikel automatik bulan ini': 'automated articles this month', 'artikel menggunakan DataForSEO': 'articles using DataForSEO', 'Dikemas kini': 'Updated', 'Belum disimpan': 'Not saved', 'DataForSEO direkodkan menggunakan nilai kos yang dipulangkan oleh respons API. DeepSeek dan GPT Image direkodkan daripada token penggunaan model semasa. Kos domain atau perkhidmatan yang tiada API bil tidak boleh dikesan secara automatik.': 'DataForSEO is recorded using the cost returned by its API. DeepSeek and GPT Image are recorded from current model usage tokens. Domain costs and services without billing APIs cannot be detected automatically.', 'Kos tetap bulanan': 'Fixed monthly cost', 'Pecahan daripada kos tahunan': 'Allocation from annual cost', 'Hosting statik semasa': 'Current static hosting', 'Perkhidmatan lain': 'Other service', 'Kos berjaya disimpan.': 'Costs saved successfully', 'Tetapan kos tidak dapat disimpan.': 'Cost settings could not be saved.', 'Menyimpan...': 'Saving...',
